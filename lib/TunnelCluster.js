...
TunnelCluster.prototype.open = function() {
    ...
    function conn_local() {
        ...
        // create a socket to our local server!
        ...
        local.once('connect', function() {
            ...
            /*
             * This looks to be like the meat of the code
             */
            ...
            if (opt.local_host) {
                ...
                // take the remote stream and pipe into the header
                // host transform
            ...
            // stream is remote. Take the stream and write to the local
            // stream and then write back to the remote stream...
