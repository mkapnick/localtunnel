...
Tunnel.prototype._init = function(cb) {
    ...
    // we need to hit `localhost.me/?new` to register the newly generated
    // url with the localtunnel.me server/db
    (function get_url() {
        request(params, function(err, res, body) {
            ...
            // self will contain this data, and we'll also pass this
            // data to create a new TunnelCLuster
            cb(null, {
